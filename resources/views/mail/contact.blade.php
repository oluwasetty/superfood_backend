...
<html>
    ...
    <body bgcolor="#fafafa" style="font-family:'Open Sans', -apple-system, Helvetica, Arial, sans-serif !important;">
            ...
            <tbody>
                <tr>
                    <td align="center" valign="top">
                        <table class="outer-table mktoContainer" id="template-wrapper" summary="outer-table"
                            align="center" valign="top" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                                                ...
                                                <td align="center" valign="top" style="background-color: #FFFFFF;">
                                                    <div class="mktoImg" id="mkto-header-image" style="margin: 30px 0;">
                                                        <img src="{{ config('app.url', 'http://localhost') }}/assets/img/logo.png"
                                                            width="120" style="border:0; width:120px;">
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <td>
                                    <div class="mktoText" id="bodyTxt"
                                        ...
                                        <p>
                                            ...
                                            {{-- <a href="{{ config('app.url', 'http://localhost') }}"=id="cta-btn"
                                            mktoname="CTA Button" summary="main-cta"
                                            target="_blan=
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" style="border-radius: 35px;"
                                                                    bgcolor="#e81a1c"> <a
                                                                        href="{{ config('app.url', 'http://localhost') }}/admin/orders"
                            id="cta-btn" mktoname="CTA Button"
                            summary="main-cta" target="_blank"
                            class="button"
                            style="font-size: 12px; line-height: 22px !important; color: #ffffff !important;
                            text-decoration: none; text-decoration: none;border-radius: 35px; padding: 3px 30px; border:
                            1px solid #ff6c37; display: inline-block;font-family:'Open Sans', -apple-system, Helvetica,
                            Arial, sans-serif !important;">Proceed
        ...
        <tr class="mktoModule" id="footer">
            <td>
                <table class="inner-table" summary="inner-table" align="center" valign="top" border="0" cellpadding="0"
                    cellspacing="0" style="width: 100%;margin: 0 auto; text-align:center;" bgcolor="#FFFFFF">
                    <tbody>
                        <tr height="136">
                            <td>
