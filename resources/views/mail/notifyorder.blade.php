                    ...
                    <td align="center" valign="top">
                        <table class="outer-table mktoContainer" id="template-wrapper" summary="outer-table"
                            ...
                            <tr id="body" class="mktoModule">
                                <td>
                                    <div class="mktoText" id="bodyTxt"
                                        ...
                                        <p>
                                            Hi {{$name}}, a new order has just been placed.
                                            <br><br>
                            ...
                            <tr class="mktoModule" id="footer">
                                <td>
                                    <table class="inner-table" summary="inner-table" align="center" valign="top"
                                        border="0" cellpadding="0" cellspacing="0"
                                        style="width: 100%;margin: 0 auto; text-align:center;" bgcolor="#FFFFFF">
                                        <tbody>
                                            <tr height="136">
                                                <td>
